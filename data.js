...
window.CAKELOVER_DATA = {
  categories: [
    ...
    { id: 'customized-cakes', name: 'Customized Cakes' }
  ],
  ...
  products: [
    ...
    // === Customized Cakes ===
    { id:51, name:"Royal Multi-Tier Customized Cake", category:"customized-cakes", tag:"Custom Design", basePrice:1299, originalPrice:1899, offerText:"Customized to order", rating:4.95, img:"./cakes/cakes/birthday cake.jfif", desc:"Bespoke multi-tier celebration cake crafted to your exact design, theme, and flavor.", active:true },
    { id:52, name:"Photo Print Customized Cake",      category:"customized-cakes", tag:"Edible Photo",  basePrice:999,  originalPrice:1499, offerText:"High definition edible photo", rating:4.9, img:"./cakes/cakes/white-wedding-cake.jfif", desc:"Personalized cake featuring your favorite edible photograph printed in ultra HD.", active:true }
  ],
  ...
  reels: [
    { title: "Red Velvet Special ✨", desc: "Freshly layered cream cheese & crimson sponge", views: "14.2k", shares: "382", img: "./cakes/cakes/Red velvet Cake .jfif", link: "https://www.instagram.com/cakes_lover_namakkal_official/" },
